...
sudo su -l badman -c 'cd cloudera-playbook; git submodule update --init'


# then run the below commands
sudo su -l badman -c 'ansible-playbook -i cloudera-playbook/hosts cloudera-playbook/install-postgres-scl-rh.yml -e postgresql_version="10.5" -e postgresql_scl_version="10"'
